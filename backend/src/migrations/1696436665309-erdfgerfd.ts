...
export class Erdfgerfd1696436665309 implements MigrationInterface {
  name = 'Erdfgerfd1696436665309';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`item\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(80) NOT NULL, \`price\` int NOT NULL DEFAULT '0', \`url_image\` varchar(255) NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`gameId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`game\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(80) NULL, \`description\` varchar(255) NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`category\` (\`id\` varchar(36) NOT NULL, \`role\` enum ('ALWAYS', 'ANIMATE', 'BLOB', 'DEAMON', 'DEXTERITY', 'DODGE', 'ENVIRONMENT', 'GOLD', 'GOLEM', 'HEALTH_MAX', 'MAGIC', 'MERCHANT', 'PARTNER', 'PLANT', 'RUN', 'STRENGTH', 'THIEF', 'UNDEAD', 'WOLF') NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`achievement\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NULL, \`description\` varchar(255) NULL, \`url_image\` varchar(255) NULL, \`is_owned\` tinyint NOT NULL DEFAULT 0, \`requirementId\` varchar(36) NULL, \`effectId\` varchar(36) NULL, \`gameId\` varchar(36) NULL, UNIQUE INDEX \`REL_32b018dccddee678b546348b93\` (\`requirementId\`), UNIQUE INDEX \`REL_d97ee7ededa2f8022ae8e61ed8\` (\`effectId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`achievement\` ADD CONSTRAINT \`FK_32b018dccddee678b546348b934\` FOREIGN KEY (\`requirementId\`) REFERENCES \`requirement\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`achievement\` ADD CONSTRAINT \`FK_d97ee7ededa2f8022ae8e61ed84\` FOREIGN KEY (\`effectId\`) REFERENCES \`effect\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`achievement\` DROP FOREIGN KEY \`FK_d97ee7ededa2f8022ae8e61ed84\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`achievement\` DROP FOREIGN KEY \`FK_32b018dccddee678b546348b934\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_d97ee7ededa2f8022ae8e61ed8\` ON \`achievement\``,
    );
    await queryRunner.query(
      `DROP INDEX \`REL_32b018dccddee678b546348b93\` ON \`achievement\``,
    );
